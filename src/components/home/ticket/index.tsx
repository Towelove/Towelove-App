...
export const Ticket = ({ style, className }: Props) => {
  ...
  return (
    ...
    >
      ...
      <View
        style={{ paddingLeft: 19, paddingVertical: 5 }}
        className="absolute top-0 left-0 w-full h-full flex flex-row items-center"
      >
        <Image
          style={{
            width: 29,
        ...
        />
        <View
          style={{ paddingVertical: 1, marginLeft: 4 }}
        ...
        >
          <Image
            ...
            source={Images.lineBg}
            contentFit="contain"
            className="absolute left-0"
            alt=""
          />
          <View style={{ width: 270, height: 88 }} className="flex  flex-row">
            <View
              style={{
                flex: 1.95,
                marginTop: 26.5,
            ...
            >
              <View
                ...
                className="cursor-pointer rounded-full overflow-hidden border-[#A1B6CC] border-[1px] border-solid"
              >
                <Image
            ...
            >
              <Text
                style={{ color: '#77B9FF', fontSize: 14 }}
                className="font-SansitaOne font-bold leading-none text-center"
              >
                Together
              </Text>
              <Text
                style={{ color: '#FF98B1', fontSize: 36, marginTop: 1 }}
                className="font-SansitaOne leading-none  text-center"
              >
                {togetherDays}
              </Text>
              <Text
                style={{ marginTop: 2, color: '#FF98B1', fontSize: 14 }}
                className=" font-SansitaOne leading-none text-center"
              >
                Day
              </Text>
          ...
          <View
            style={{ width: 273, height: 30, marginTop: 24.5 }}
            className="flex flex-row justify-center items-center"
          >
            <BlueLove />
            <PinkLove style={{ marginLeft: 3 }} />
            <Text
              style={{ fontSize: 14, marginHorizontal: 10 }}
              className="text-[#77B9FF] font-SansitaOne leading-none"
            >
              LOVE SONG
            </Text>
